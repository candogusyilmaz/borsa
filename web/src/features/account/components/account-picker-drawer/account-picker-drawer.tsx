...
import classes from './account-picker-drawer.module.css';
...
export function AccountPickerDrawer({ accounts, selectedAccountId, opened, onClose, onSelectAccount }: AccountPickerDrawerProps) {
  ...
  return (
    <ResponsiveDrawer opened={opened} onClose={onClose} title="All Financial Accounts" desktopSize="420px">
