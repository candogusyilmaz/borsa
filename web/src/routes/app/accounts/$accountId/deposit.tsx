...
export const Route = createFileRoute('/app/accounts/$accountId/deposit')({
  component: DepositDrawerRoute
});

function DepositDrawerRoute() {
  ...
  return (
    <RouteDrawer
      ...
      desktopSize="480px"
      onExited={leaveRoute}>
      {({ close }) => <RecordCashActivityForm account={account} defaultType="CASH_DEPOSIT" onClose={close} />}
    </RouteDrawer>
  );
}
