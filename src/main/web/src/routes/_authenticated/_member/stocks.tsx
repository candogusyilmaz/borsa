                        ...
                        {virtualizer.getVirtualItems().map((item) => (
                            <div
                                ...
                                <Paper
                                    ...
                                    <Group gap="xs" justify="flex-end" visibleFrom="xs">
                                        <Text c={filteredSymbols[item.index].dailyChange >= 0 ? 'teal' : 'red'} fz="sm"
                                              fw={300}>
                                            {format.toCurrency(filteredSymbols[item.index].dailyChange)}
                                        </Text>
                                    </Group>
                                    <Group align="center" justify="flex-end">
                                        <Text c={filteredSymbols[item.index].dailyChangePercent >= 0 ? 'teal' : 'red'}
                                              fw={300} fz="sm">
