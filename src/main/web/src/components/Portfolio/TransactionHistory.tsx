            ...
            <Group justify="space-between" align="center">
                ...
                {totalPages > 1 && (
                    <Group justify="space-between">
                        <ActionIcon variant="transparent" c={currentPage === 1 ? 'dimmed' : 'white'}
                        ...
                        <ActionIcon variant="transparent" c={currentPage === totalPages ? 'dimmed' : 'white'}
        ...
        <Group justify="space-between" align="center" ta="right">
            <Group align="center">
                <ThemeIcon variant="transparent"
                           c={trade.type === 'BUY' ? 'blue' : trade.profit >= 0 ? 'green' : 'red'}>
                    {trade.type === 'BUY' ? <IconCirclePlus/> : trade.profit >= 0 ? <IconTrendingUp3/> :
                        <IconTrendingDown3/>}
                </ThemeIcon>
                <Stack gap={2}>
                    <Group gap="xs" align="center" ml={3}>
                        ...
                        <Badge size="xs" variant="light"
                               color={trade.type === 'BUY' ? 'blue' : trade.profit >= 0 ? 'green' : 'red'}>
                            {trade.type}
                        </Badge>
                    </Group>
            ...
            <Group align="center" miw={rem(300)}>
                <Stack gap={2} miw={rem(150)}>
                    <Group gap={4} align="center" justify="flex-end">
                        ...
                        <Text
                            fw={500}>{`${format.toHumanizedNumber(trade.quantity)} share${trade.quantity === 1 ? '' : 's'}`}</Text>
                    </Group>
                    <Text size="xs" c="dimmed">
