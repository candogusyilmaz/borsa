...
export function SellTransactionForm({stockId, close}: SellTransactionFormProps) {
    ...
    const quantityRightSection = stockInHolding && (
        <Button size="xs" fz={12} variant="transparent" c="gray"
                onClick={() => form.setFieldValue('quantity', stockInHolding.quantity)}>
            Max
        </Button>
    );
    ...
    return (
        <form onSubmit={handleFormSubmit}>
            <Stack>
                ...
                <Button type="submit" color="blue" loading={mutation.isPending || mutation.isSuccess}
