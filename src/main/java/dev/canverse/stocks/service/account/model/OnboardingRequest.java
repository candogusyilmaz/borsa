...
public record OnboardingRequest(
        @NotNull @NotEmpty String dashboardName,
        @NotNull @Length(min = 3, max = 3) String currencyCode,
        @NotNull PortfolioSetup portfolio) {

    public record PortfolioSetup(
            @NotNull @NotEmpty String portfolioName,
