...
public record ReconciliationPreviewResponse(
    ...
    public static ReconciliationPreviewResponse from(ReconciliationPreviewView view) {
        return new ReconciliationPreviewResponse(
                ...
                view.statementOpeningBalance().canonical(),
                view.statementClosingBalance().canonical(),
                view.ledgerOpeningBalance().canonical(),
                view.ledgerClosingBalanceBeforeAdjustment().canonical(),
                view.openingDifference().canonical(),
                view.periodNetPostedAmount().canonical(),
                view.closingDifference().canonical(),
                view.periodPostingCount(),
                view.totalPostingCountThroughClosing(),
                view.projectionVersion(),
                view.admissibleResolutions(),
                view.warnings());
    }
}
