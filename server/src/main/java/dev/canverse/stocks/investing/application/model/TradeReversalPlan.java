...
public record TradeReversalPlan(UUID ownerUserAccountId, UUID accountId, UUID instrumentId, String currencyCode, SecurityPosting reversalPosting,
        PositionProjection existingProjection, TradeReplayResult replay) {}
